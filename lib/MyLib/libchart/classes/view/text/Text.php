<?php
	...
	class Text {
		...
		public function Text() {
			...
			$this->fontCondensed = $baseDir . "fonts/DFMRG3.TTF";
			$this->fontCondensedBold = $baseDir . "fonts/DFKTL8.TTF";
		}
		 ...
		 */
		public function printText($img, $px, $py, $color, $text, $fontFileName, $align = 0,$fontSize=10) {
		...
		public function printCentered($img, $py, $color, $text, $fontFileName) {
			$this->printText($img, imagesx($img) / 2, $py, $color, $text, $fontFileName, $this->HORIZONTAL_CENTER_ALIGN | $this->VERTICAL_CENTER_ALIGN,15);
		}
